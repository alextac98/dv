...
fn unit_str_to_unit_simple_simple() {
    ...
    assert_eq!(dv.unit(), [1, 0, -1, 0, 0, 0, 0], "Incorrect unit for mi/hr");
}
...
fn unit_str_to_unit_simple_exponent() {
    ...
    assert_eq!(dv.unit(), [1, 0, -2, 0, 0, 0, 0], "Incorrect unit for mi/hr^2");
...
fn unit_str_to_unit_complex() {
    ...
    assert_eq!(dv.unit(), [1, 1, -3, -1, 0, 0, 0], "Incorrect unit for BTU-in/hr-ft^2-F");
}

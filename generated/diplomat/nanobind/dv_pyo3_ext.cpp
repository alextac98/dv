...
void add_BaseUnits_binding(nb::module_);
void add_DimensionalVariable_binding(nb::module_);
}
...
NB_MODULE(dv_pyo3, mod)
{
    using namespace dv_pyo3;
    ...
    // Add bindings
    add_BaseUnits_binding(mod);
    add_DimensionalVariable_binding(mod);
